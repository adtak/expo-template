...
<!-- Map each acceptance criterion from the original issue to the implementation step that covers it.
     Use a table format for traceability. -->

| Criteria | Covered by |
|----------|-----------|
| Criterion from the issue | Step N |
